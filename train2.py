    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            # end batch ------------------------------------------------------------------------------------------------
                    ...
                    #     f1 = save_dir / f'train_batch1{i}.jpg'
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/NWPU_VHR.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default=ROOT / 'runs_NWPU_VHR/train', help='save to project/name')
    parser.add_argument('--name', default='exp_yolol_o', help='save to project/name')
